...
.scale-\[var\(--base-scale\)\] {
  --tw-scale-x: var(--base-scale);
  --tw-scale-y: var(--base-scale);
  transform: translate(var(--tw-translate-x), var(--tw-translate-y)) rotate(var(--tw-rotate)) skewX(var(--tw-skew-x)) skewY(var(--tw-skew-y)) scaleX(var(--tw-scale-x)) scaleY(var(--tw-scale-y));
}
.transform {
  transform: translate(var(--tw-translate-x), var(--tw-translate-y)) rotate(var(--tw-rotate)) skewX(var(--tw-skew-x)) skewY(var(--tw-skew-y)) scaleX(var(--tw-scale-x)) scaleY(var(--tw-scale-y));
...
.text-\[\#EAAA00\] {
  --tw-text-opacity: 1;
  color: rgb(234 170 0 / var(--tw-text-opacity, 1));
}
.text-black {
  --tw-text-opacity: 1;
...
.group:hover .group-hover\:scale-\[var\(--hover-scale\)\] {
  --tw-scale-x: var(--hover-scale);
  --tw-scale-y: var(--hover-scale);
  transform: translate(var(--tw-translate-x), var(--tw-translate-y)) rotate(var(--tw-rotate)) skewX(var(--tw-skew-x)) skewY(var(--tw-skew-y)) scaleX(var(--tw-scale-x)) scaleY(var(--tw-scale-y));
}

.group:hover .group-hover\:text-\[\#EAAA00\] {
  --tw-text-opacity: 1;
  color: rgb(234 170 0 / var(--tw-text-opacity, 1));
}
